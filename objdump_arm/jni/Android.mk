...
#include $(CLEAR_VARS)
#LOCAL_MODULE    := objdump_arm
#LOCAL_C_INCLUDES := objdump.h my_constant.h 
...
include $(CLEAR_VARS)
LOCAL_MODULE    := libtool_arm
LOCAL_C_INCLUDES := libtools.h my_constant.h 
LOCAL_SRC_FILES	:= libtools.c \
	xfunc.c
LOCAL_LDLIBS := -L$(LOCAL_PATH) -llog 
include $(BUILD_EXECUTABLE) 
